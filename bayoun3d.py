...
time.sleep(1)
os.system("clear")
os.system("figlet BAYON3D")
time.sleep(1)
print("เฟสคนสร้าง [https://www.facebook.com/profile.php?id=100016690571487]")
#########################
time.sleep(1)
print("เช็กข้อมูล...")
time.sleep(3)
num = input('\033[36m(ตัวอย่าง +6694xxxxxx)\033[35m --->  ')
lim = int(input('ใส่จำนวน --->   '))
numplus = '+' + num
def spam():
        try:
